...
public class serializablelistofcategorychannel implements Serializable {
    ...
    public serializablelistofcategorychannel(String str_name, String str_channel, int image_id) {
        this.str_name = str_name;
        this.str_channel = str_channel;
        this.image_id = image_id;
    }
